...
* Permalink: <https://w3id.org/5s-crate/0.4-DRAFT> (TODO)
...
* Example crate "Hutch": [GitHub LFS](https://github.com/trefx/5s-crate/tree/main/0.4-DRAFT/example-hutch) [ro-crate-metadata.json](example-hutch/data/ro-crate-metadata.json) [ro-crate-preview.html](example-hutch/data/ro-crate-preview.html) 
...
```json
{
  "@id": "./",
  "@type": "Dataset",
  "conformsTo": {"@id": "https://w3id.org/5s-crate/0.4-DRAFT"},
  "hasPart": [
  ],
...
{  
  ...
  "object": {"@id": "./"},
  "instrument": {"@id": "https://w3id.org/5s-crate/0.4-DRAFT"},
  "agent": {"@id": "#validator-a4a66c63-2fe0-4c57-830d-268a40718313"},
  "actionStatus": "http://schema.org/CompletedActionStatus"
}
```
